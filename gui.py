...
class VideoThread(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            cv2.line(cv_img, (40,posX+240), (620,posX+240),color,1)
            for i in range(1,17):
                if i%3 == 1:

                    cv2.line(cv_img, (X1,posX+i*30), (X1+30,posX+i*30),color,3)
                    cv2.line(cv_img, (X2,posX+i*30), (X2-30,posX+i*30),color,3)
                else:
                    cv2.line(cv_img, (X1,posX+i*30), (X1+20,posX+i*30),color,2)
                    cv2.line(cv_img, (X2,posX+i*30), (X2-20,posX+i*30),color,2) 
